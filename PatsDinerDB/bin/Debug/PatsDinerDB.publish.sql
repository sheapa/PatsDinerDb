/*
Deployment script for PatsDinerDB
...
GO
:setvar DatabaseName "PatsDinerDB"
:setvar DefaultFilePrefix "PatsDinerDB"
:setvar DefaultDataPath "C:\Users\patri\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
:setvar DefaultLogPath "C:\Users\patri\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '9b6e50f3-029b-4739-a8f8-986c68fc8a6f')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('9b6e50f3-029b-4739-a8f8-986c68fc8a6f')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '428e3c5a-9926-4f9e-809e-16fe81f4a340')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('428e3c5a-9926-4f9e-809e-16fe81f4a340')
